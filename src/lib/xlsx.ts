...
/**
 * Three formats, referenced by index from the cells.
 *
 * `0` plain, `1` money to two decimals with thousands separators, `2` a date.
 * Money has to be a real number or the column will not sum, which is the first
 * thing anybody does to an exported ledger.
 */
